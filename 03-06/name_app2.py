...
name_cards = [{'cno': 1, 'name':'spring', 'tel':'1234'}, {'cno': 2, 'name':'summer','tel':'2222'}]
cno = 3
...
def list():
    ...
    message = ''
    if error=='insert':
        massage = '연락처가 이미 존재합니다'
    elif error=='delete':
        message = '연락처를 찾을 수 없습니다다'
    return render_template("card2/list.html", name_cards=name_cards)
...
def insert():
    ...
    # 이름과 연락처가 모두 중복이면 에러 코드를 가지고 /card/list로 이동
